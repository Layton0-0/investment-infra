#!/usr/bin/env bash
# ============================================================
# OCI Mumbai (ap-mumbai-1) Compute Instance Creation Macro
# - Region: ap-mumbai-1 (India West Mumbai)
# - Shape: VM.Standard.A1.Flex (1 OCPU, 6GB)
# - Image: Ubuntu (ocid1.image.oc1.ap-mumbai-1.aaaaaaaahx6...)
#
# IMPORTANT: authorization, opc-request-id, x-date, x-content-sha256
# are session-bound. Replace them from browser DevTools (Network tab)
# when re-running, or use OCI CLI for repeatable runs.
# ============================================================
